...
public class PriceRepositoryTest {
    ...
    public void test_findAllByAmountBetweenAndCurrency() {
        ...
        final List<Price> byn = repository.findAllByAmountBetweenAndCurrency(
                BigDecimal.valueOf(10), BigDecimal.valueOf(100), BYN, PageRequest.of(0, 10));
        ...
        final List<Price> eur = repository
                .findAllByAmountBetweenAndCurrency(BigDecimal.valueOf(10), BigDecimal.valueOf(100),
                        EUR, PageRequest.of(1, 2));
        ...
        final List<Price> usd = repository
                .findAllByAmountBetweenAndCurrency(BigDecimal.valueOf(10), BigDecimal.valueOf(100),
                        USD, PageRequest.of(0, 10));
