...
public class ProductRepositoryTest {
    ...
    public void test_findAllByPrice() {
        ...
        final List<Product> byPrice1 = repository.findAllByPrice(BigDecimal.valueOf(10.01),
                BYN, PageRequest.of(0, 10));
        ...
        final List<Product> byPrice2 = repository.findAllByPrice(BigDecimal.valueOf(20.01),
                EUR, PageRequest.of(0, 10));
